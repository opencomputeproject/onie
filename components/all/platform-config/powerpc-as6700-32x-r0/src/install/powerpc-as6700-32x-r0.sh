...
platform_bootcmd='usb start; fatload usb 0:1 0x10000000 onl-loader; setenv bootargs console=$consoledev,$baudrate onl_platform=powerpc-as6700-32x-r0; bootm 0x10000000'
