#!/bin/sh
sed -i "s/onie_machine=.*/onie_machine=pegatron_fn8032_bnf/g" /etc/machine.conf
sed -i "s/onie_machine_rev=.*/onie_machine_rev=0/g" /etc/machine.conf
sed -i "s/onie_platform=.*/onie_platform=x86_64-pegatron_fn8032_bnf-r0/g" /etc/machine.conf
onie-syseeprom -f -s 0x21=FN8032_BNF
onie-syseeprom -f -s 0x27=pegatron_fn8032_bnf
onie-syseeprom -f -s 0x28=x86_64-pegatron_fn8032_bnf-r0
